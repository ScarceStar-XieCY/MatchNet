...
from collect_data.overlap_detect import OverlapDetector
...
if __name__ == "__main__":
    ...
    for kit_index in tqdm(range(0,200)):
        ...
        logger.warning("before fing obj coord.")
        ...
        for one_random_idx in obj_index:
            ...
            obj_mask = coord2mask(obj_mask_coord,h,w,False)
            arm_info_dict[i] = {INIT_POINT:uv_coord, FINAL_POINT:random_place_2d,ROTATION:random_theta,FINAL_POINT3D:random_place_3d,HOLE_MASK:selected_mask,OBJ_MASK:obj_mask}
